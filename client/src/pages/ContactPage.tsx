...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-rose-900 text-white">
      <div className="relative mx-auto max-w-7xl px-4 py-12">
        <h1 className="mb-8 text-4xl font-bold tracking-tight sm:text-5xl xl:text-6xl">
          Contact Us
        </h1>

        <div className="grid gap-12 lg:grid-cols-2">
          {/* Contact Form */}
          <Card className="bg-white/10 p-6 shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">123 Bike Lane, Cycling City, CC 12345</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
